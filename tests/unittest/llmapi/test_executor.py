...
def test_abort_on_DetokenizedGenerationResultBase():
    """Test abort() on DetokenizedGenerationResultBase.
...
def test_PostprocWorker_Output_should_abort():
    """Test PostprocWorker.Output should_abort flag.
...
def test_handle_response_propagates_should_abort():
    """Test _handle_response propagates should_abort flag.
...
def test_get_params_for_first_rsp_returns_disaggregated_params_once():
    """Verify _get_params_for_first_rsp extracts params once.

    Extracts disaggregated_params from the GenerationResult on the first
    call and returns None after.
...
def test_PostprocWorker_disaggregated_params():
    """Test disaggregated_params persistence in PostprocWorker.
