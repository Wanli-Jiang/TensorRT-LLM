...
readonly SUBMISSIONS=${EXP}/submissions/mtp3-nochunk-ab.tsv
readonly CONFIG_DIR=${EXP}/recipes/mtp3-nochunk-ab
...
submit_arm chunk1024
submit_arm chunk8448
submit_arm nochunk8448
