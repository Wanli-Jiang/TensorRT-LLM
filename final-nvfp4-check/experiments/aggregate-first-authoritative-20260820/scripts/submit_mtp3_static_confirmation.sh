...
readonly SUBMISSIONS=${EXP}/submissions/mtp3-static-confirmation.tsv
readonly CONFIG_DIR=${EXP}/recipes/mtp3-static-confirmation
...
submit_arm()
{
    ...
    local arm="mtp3-static-confirm-${variant}-v1"
...
submit_arm static528-budget8448-curve
submit_arm static528-budget33792-c640
