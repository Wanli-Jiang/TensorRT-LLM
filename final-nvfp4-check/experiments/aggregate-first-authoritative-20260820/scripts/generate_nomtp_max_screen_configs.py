...
"""Generate matched C2048 configs for the aggregate no-MTP maximum search."""
...
VARIANTS: dict[str, dict[str, Any]] = {
    "nochunk-budget8448-control": {
        ...
        "role": "same-day trusted-record control rerun",
    },
    "chunk-budget8448": {
        "enable_chunked_prefill": True,
        "max_num_tokens": 8448,
        "moe_max_num_tokens": 8448,
        "role": "chunked scheduling treatment with one-full-prefill budget",
    },
    "chunk-budget16896": {
        "enable_chunked_prefill": True,
        "max_num_tokens": 16896,
        "moe_max_num_tokens": 16896,
        "role": "chunked scheduling treatment with two-full-prefill budget",
    },
}
...
def _render(variant: str, spec: dict[str, Any]) -> dict[str, Any]:
    ...
    config["name"] = f"nvfp4-current-agg-ht-nomtp-max-screen-{variant}"
    ...
    cache_root = f"/tmp/nvfp4-nomtp-max-screen-{variant}/{{node}}"
...
def main() -> None:
    output_dir = EXPERIMENT / "recipes" / "nomtp-max-screen"
