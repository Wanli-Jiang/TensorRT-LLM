...
readonly LEDGER=${EXP}/submissions/disaggregate-client-oversample-retry.tsv
...
readonly CONFIG=${EXP}/recipes/disaggregate/best-noeplb-${mode}-client-oversample-retry.yaml
readonly OUTPUT=${EXP}/outputs/disaggregate/${mode}-best-noeplb-client-oversample-retry
readonly SUBMIT_LOG=${EXP}/submissions/disaggregate-${mode}-client-oversample-retry.submit.log
