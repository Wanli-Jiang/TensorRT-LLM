...
readonly SUBMISSIONS=${EXP}/submissions/aggregate-v2-diagnostics.tsv
...
submit_arm \
    ll-nomtp-v2 \
    "${EXP}/recipes/aggregate-ll-nomtp-tp8-trtllm-kv-v2.yaml" \
    2
submit_arm \
    ll-mtp3-v2 \
    "${EXP}/recipes/aggregate-ll-mtp3-tp8-trtllm-kv-v2.yaml" \
    2
submit_arm \
    ht-nomtp-noeplb-v2 \
    "${EXP}/recipes/aggregate-ht-nomtp-adp16-cutedsl-noeplb-kv-v2.yaml" \
    4
submit_arm \
    ht-mtp3-noeplb-v2 \
    "${EXP}/recipes/aggregate-ht-mtp3-adp16-cutedsl-noeplb-kv-v2.yaml" \
    4
