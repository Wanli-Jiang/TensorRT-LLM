...
readonly SUBMISSIONS=${EXP}/submissions/mtp3-budget33792-curve.tsv
readonly CONFIG_DIR=${EXP}/recipes/mtp3-budget33792-curve
...
submit_arm()
{
    ...
    local arm="mtp3-record-${variant}-v1"
...
submit_arm static528-budget33792-curve
submit_arm static528-budget67584-c640
