...
readonly SUBMISSIONS=${EXP}/submissions/nomtp-max-screen.tsv
readonly CONFIG_DIR=${EXP}/recipes/nomtp-max-screen
...
submit_arm()
{
    ...
    local arm="nomtp-max-screen-${variant}-v1"
...
submit_arm nochunk-budget8448-control
submit_arm chunk-budget8448
submit_arm chunk-budget16896
