...
readonly SUBMISSIONS=${EXP}/submissions/nomtp-budget-confirmation.tsv
readonly CONFIG_DIR=${EXP}/recipes/nomtp-budget-confirmation
...
submit_arm()
{
    ...
    local arm="nomtp-budget-confirm-${variant}-v1"
...
submit_arm chunk-budget16896-curve
submit_arm chunk-budget33792-c2048
